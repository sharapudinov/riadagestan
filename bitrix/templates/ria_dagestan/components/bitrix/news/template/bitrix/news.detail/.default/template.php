...
<div class="news_item1">
    ...
    <?
        $file=CFile::ResizeImageGet($arResult["PROPERTIES"]["IMAGES"]["VALUE"][0],array('height'=>250,'width'=>250,BX_RESIZE_IMAGE_PROPORTIONAL ));
        $APPLICATION->AddViewContent('shared_image_path',"https://".$_SERVER['SERVER_NAME'].$file['src']);

        if (is_array($arResult["PROPERTIES"]["IMAGES"]["VALUE"]) || $arResult["PROPERTIES"]["VIDEO"]["VALUE"] != "")
        {
...
<span class="mvideo">
    ...
    <div class="likely likely-small">
        ...
        <div class="pinterest" data-media='<?="http://".$_SERVER['SERVER_NAME'].CFile::GetPath($arResult["PROPERTIES"]["IMAGES"]["VALUE"][0])?>'></div>
    </div>
    <!--test-->
    <script type="text/javascript">
        !function t(e, n, i) {
    ...
    <? if ($arResult["PROPERTIES"]["on_of_views"]["VALUE"] == 1): ?>
		...
		<div class="itemContentFooter">
            ...
            <b>
            <? $frame = $this->createFrame('view_counter_area', false)->begin('загрузка');
        ?>
