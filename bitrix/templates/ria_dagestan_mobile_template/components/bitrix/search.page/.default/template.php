...
<style>
.poisk{display:none;}
.rightfotoreportag{display:none;}
.media_block_head{display:none;}
.media_block{display:none;}
</style>
<div class='box'>
    <div class="media_block_head"><h1>Результаты поиска</h1></div>
...
<?elseif(count($arResult["SEARCH"])>0):?>
	...
	<?foreach($arResult["SEARCH"] as $arItem):?>
			...
			<div class="search_block">
                <div class="b-list-item__info">
                    <span class="b-list-item__type">Новость:</span> 
                        <small><?=GetMessage("SEARCH_PATH")?>&nbsp;<?=$arItem["CHAIN_PATH"]?></small>
                        <span class="b-list-item__date"> — <?=$arItem["DATE_CHANGE"]?></span>
                </div>
                <a class="b-list-item__link" href="<?echo $arItem["URL"]?>">
                    <span class="b-list-item__title"><?echo $arItem["TITLE_FORMATED"]?></span>
                    <div class="b-list-item__rightcol"><?echo $arItem["BODY_FORMATED"]?></div>
                </a>
            </div> 
