        ...
        <div class="m_news_info">
			...
			<span class="itemCategory">
				<span><?= GetMessage("posted_in") ?>:&nbsp;&nbsp;</span><a
                    href="/mobile_app<? echo($arResult["SECTION"]["PATH"][0]["SECTION_PAGE_URL"]) ?>"><? echo $arResult["SECTION"]["PATH"][0]["NAME"] ?></a>
                <? if ($arResult["SECTION"]["PATH"][1]["NAME"] != null): ?>
                    &nbsp;-&nbsp;<a
                        href="/mobile_app<? echo($arResult["SECTION"]["PATH"][1]["SECTION_PAGE_URL"]) ?>"><? echo $arResult["SECTION"]["PATH"][1]["NAME"] ?></a>
                <? endif; ?>
			</span>
...
<div class="box">
    ...
    $component->arResult["LIST_SUB_NEWS"] = $APPLICATION->IncludeComponent("bitrix:news.list", "main_theme_news", array(
        ...
        "PROPERTY_CODE" => "",
        "CHECK_DATES" => "Y",
        "DETAIL_URL" => "/mobile_news/news/#SECTION_CODE#/#ELEMENT_CODE#/",
