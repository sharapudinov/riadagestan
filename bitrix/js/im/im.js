...
BX.IM.prototype.openSettings = function(params)
{
	...
	if (this.desktopVersion >= 42 && /windows/.test(navigator.userAgent.toLowerCase()) && BXDesktopSystem.GetNotifyPosition)
	{
...
BX.IM.WebRTC.prototype.cancelInviteTransfer = function()
{
	...
	BX.MessengerCommon.phoneUnhold();
}
