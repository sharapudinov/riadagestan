		...
		buildTopButtons:  function()
		{
			...
			if (this.buttonsCont)
			{
				this.sectionButton = this.buttonsCont.appendChild(BX.create("button", {
					props: {className: "ui-btn ui-btn-light-border ui-btn-themes"},
				...
				if (this.util.userIsOwner())
				{
					this.syncButton = this.buttonsCont.appendChild(BX.create("BUTTON", {
						props: {className: "ui-btn ui-btn-icon-business ui-btn-light-border ui-btn-themes"}
					}));
				...
				{
					this.settingsButton = this.buttonsCont.appendChild(BX.create("BUTTON", {
						props: {className: "ui-btn ui-btn-icon-setting ui-btn-light-border ui-btn-themes"}
					}));
