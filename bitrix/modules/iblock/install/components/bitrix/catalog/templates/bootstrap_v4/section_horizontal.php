...
?>
	<?
			/* todo:
				sidebar-left > "order-2 order-sm-1"
		...
		<div class="<?=$contentBlockClass?>">
			<? if ($isFilter): ?>
				<div class="row">
					<div class="col<?=(isset($arParams['FILTER_HIDE_ON_MOBILE']) && $arParams['FILTER_HIDE_ON_MOBILE'] === 'Y' ? ' d-none d-block-sm' : '')?>">
					...
					if (ModuleManager::isModuleInstalled("sale"))
					{
						...
						if (!empty($arRecomData) && $arParams['USE_GIFTS_SECTION'] === 'Y')
						{
							...
							<div data-entity="parent-container">
								...
								$APPLICATION->IncludeComponent('bitrix:sale.products.gift.section', '', array(
										'IBLOCK_TYPE' => $arParams['IBLOCK_TYPE'],
										'IBLOCK_ID' => $arParams['IBLOCK_ID'],
...
<? if ($isSidebar): ?>
	<?
	/* todo:
		sidebar-left > "order-1 order-sm-2"
