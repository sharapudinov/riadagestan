...
$MESS["WIZ_TEMPLATE_ADAPT_HORIZONTAL"] = "Media: адаптивный шаблон новостного портала";
...
$MESS["wiz_structure_data"] = "Установить демонстрационные данные новостного портала";
$MESS["wiz_install_eshopapp"] = "Установить мобильное приложение для новостного портала";
$MESS["wiz_restructure_data"] = "Переустановить демонстрационные данные новостного портала";
...
$MESS["WIZ_COMPANY_LOGO"] = "Логотип (рекомендуемый размер 224 X 38)";
$MESS["WIZ_COMPANY_LOGO_RETINA"] = "Логотип для ретина устройств (рекомендуемый размер 448 X 76)";

$MESS["WIZ_COMPANY_LOGO_FOOTER"] = "Логотип в подвале (рекомендуемый размер 224 X 38)";
$MESS["WIZ_COMPANY_LOGO_FOOTER_RETINA"] = "Логотип в подвале для ретина устройств (рекомендуемый размер 448 X 76)";
...
$MESS["WIZ_COMPANY_NAME_DEF"] = "Media: новостной портал";
...
$MESS["WIZ_COMPANY_COPY_DEF"] = "&copy; Media. Информация сайта защищена законом об авторских правах.";
...
$MESS["WIZ_SHOP_OF_NAME_DEF"] = "ООО \"Media\"";
$MESS["WIZ_SHOP_OF_NAME_DEF_UA"] = "ТОВ \"Media\"";
...
$MESS["WIZ_SHOP_PRICE_BASE_TEXT1"] = "В решении \"Media\" используется в качестве публичных цен для просмотра и покупки базовая цена (BASE). В текущий момент для группы \"Все пользователи (в том числе неавторизованные)\" включено право на данный тип цены. Таким образом данная группа будет видеть цены в решении.";
...
$MESS["wiz_site_desc"] = "Готовый новостной портал на 1С-Битрикс.";
